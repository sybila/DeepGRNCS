...
parser.add_argument('--save_name', type=str, help='Input the result file.')
parser.add_argument('--save_file_name', type=str, default = 'Result', help='Name of the result file')
